...
class RoundXPageState extends State<RoundXPage> {
  ...
  void previousPlayer()
  {
    ...
    {
      globals.currentGame!.currentPlayer = globals.currentGame!.totalPlayers() - 1;
    }
  ...
  void nextPlayer()
  {
    globals.currentGame!.currentPlayer = (globals.currentGame!.currentPlayer + 1) % globals.currentGame!.totalPlayers();
    Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: const RoundXPage()));
  }
        ...
        child: Center(
          child: Column(
            children: [
              ...
              Row(children: [
                Padding(padding: const EdgeInsets.fromLTRB(130, 10, 0, 0),
                  child: 
                    SizedBox(
                      width: 100,
                      height: 50,
                  ...
                  child: 
                    IconButton(
                      ...
                      onPressed: () {
                        if (score != 0)
                        {
                          globals.currentGame!.players[playerIndex].points += score;
                          score = 0;
                          fieldText.clear();
                          nextPlayer();
                        }
